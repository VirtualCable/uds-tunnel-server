...
pub struct ServerConfig {
    ...
    pub broker_api_url: String, // URL of the broker API, e.g., https://broker.example.com/uds/rest/ticket
...
mod tests {
    ...
    fn test_parse_config() {
        let toml_str = r#"
            ...
            broker_api_url = "https://broker.example.com/uds/rest/ticket"
            verify_ssl = false
        ...
        assert_eq!(config.broker_api_url, "https://broker.example.com/uds/rest/ticket".to_string());
